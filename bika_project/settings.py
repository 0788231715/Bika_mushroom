...
# Add Kinyarwanda to Django's supported languages list
...
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER", "abeliniyigena@gmail.com")
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD", "0788231715")
...
BIKA_SETTINGS = {
    "APP_NAME": "Bika",
    "APP_DESCRIPTION": "Your Inventory Our Innovation",
    "APP_VERSION": "1.0.0",
